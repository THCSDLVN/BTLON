...
public class CreateOrder extends JDialog {
	...
	public CreateOrder(JComboBox b) {
		...
		yeahLbl = new JLabel("-",JLabel.CENTER);
		yeahLbl.setText(year+" - ");
		yeahLbl.setBounds(128, 90, 49, 15);
		contentPanel.add(yeahLbl);
		
		monthTxtLbl = new JLabel(" -",SwingConstants.RIGHT);
		monthTxtLbl.setBounds(174, 90, 28, 15);
		contentPanel.add(monthTxtLbl);
		
		dayTxtLbl = new JLabel("");
		dayTxtLbl.setHorizontalAlignment(SwingConstants.LEFT);
		dayTxtLbl.setBounds(207, 90, 28, 15);
		contentPanel.add(dayTxtLbl);
		
		hourTxtLbl = new JLabel(":");
		hourTxtLbl.setHorizontalAlignment(SwingConstants.LEFT);
		hourTxtLbl.setBounds(262, 90, 34, 15);
		contentPanel.add(hourTxtLbl);
		
		minTxtLbl = new JLabel("");
		minTxtLbl.setHorizontalAlignment(SwingConstants.LEFT);
		minTxtLbl.setBounds(281, 90, 49, 15);
